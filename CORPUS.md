...
| Set | Game | Year | ROM | Extract | Lifts | Builds | Boots | Renders | Motion | Furthest | Funcs | Hints | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `skisuprg` | Sega Ski Super G | 1996 | yes | ok | ok | ok | yes | no | blank | BOOTS-BLANK | 8573 | 2 | MAME cannot run this set either. Drew a partial screen while port A of the 315-5649 wrongly returned the cabinet inputs; |
